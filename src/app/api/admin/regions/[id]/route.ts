...
// PATCH — update a region override (admin password required)
...
// DELETE — delete a region override (admin password required)
export async function DELETE(
  ...
  const { error } = await supabase.from("region_overrides").delete().eq("id", id);
